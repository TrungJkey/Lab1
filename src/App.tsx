			...
			<div className="sider">
				<div className="sider-content">
					...
					<div className="tag-content">
						<ul>
							<li>01/10/2002</li>
							<li>trungstkt0110@gmail.com</li>
							<li>Sa Thầy - Kon Tum </li>
							<li>0905070637</li>
						<a href="https://github.com/TrungJkey">	<GitHub /></a>
            <a href="https://www.facebook.com/Trungka.vlogs/">	<Facebook /></a>
            <a href="https://www.youtube.com/channel/UCyRcNrUXdqnNy06WOoZWY4g">	<Youtube /></a>
						</ul>
					</div>
				</div>
				<div className="sider-content">
